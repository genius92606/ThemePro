...
function manageSubmitButton()
{
	...
	$("#submitButton").click(function(){
		...
		$("#tabContent").show();
	  	...
	  	var data = {"text": text};
        console.log(data)
	    $.post( "http://172.18.0.2:5000/getConll", data ,function( dataJSON ) {
		    displayTree(dataJSON, 0);
		    displayCorefs(dataJSON);
		    globalDATA = dataJSON;
		}, "json");

		$.post( "http://172.18.0.2:5000/getThematicity", function( dataJSON ) {
		    displayThem(dataJSON);
   		    displayArguments(dataJSON);

		}, "json");

		$.post( "http://172.18.0.2:5000/getThematicProgression", function( dataJSON ) {
